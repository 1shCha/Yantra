...
import type { YantraCanvasApi } from '../../shared/canvas-api';
import { useCanvasStore } from '../stores/canvasStore';
import type { PersistenceStatus } from './CanvasPersistenceStatus';
...
export function useCanvasFilePersistence(): PersistenceStatus {
  ...
  useEffect(() => {
    ...
    const unsubscribeBeforeClose = canvasApi.onBeforeClose?.(() => {
      void saveIfDirty(canvasApi);
    });
